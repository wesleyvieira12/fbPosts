<?php
	if (isset($_POST["submit"])) {
		...
		$from = 'Solicitação de solução de problema'; 
		$to = 'taciovictor5@gmail.com'; 
		$subject = 'Solicitação de solução de problema - (CampanhasFb)';
...
<html lang="pt_br">
  <head>
    ...
    <title>Formulário - Problema ao logar-se</title>
  	...
  	<div class="container">
  		<div class="row">
  			<div class="col-md-6 col-md-offset-3">
  				<h1 class="page-header text-center">Problema ao logar-se</h1>
