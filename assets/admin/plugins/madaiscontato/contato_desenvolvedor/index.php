<?php
	if (isset($_POST["submit"])) {
		...
		$from = 'Contato Tácio Victor (campanhasfb)'; 
		$to = 'rogeriomedeiros001@gmail.com'; 
		$subject = 'Solicitação de solução de problema - Desenvolvedor(CampanhasFb)';
		
		$body ="Usuário: $name\n E-Mail: $email\n Descriçao do Problema: $senha\n Não se esqueça de modificar o acesso deste usuário em http://campanhasfb.com.br/premium/";
...
<html lang="pt_br">
  <head>
    ...
    <title>Contato com desenvolvedor (campanhas fb)</title>
  	...
  	<div class="container">
  		<div class="row">
  			<div class="col-md-6 col-md-offset-3">
  				<h1 class="page-header text-center">Contato com desenvolvedor</h1>
				<form class="form-horizontal" role="form" method="post" action="index.php">
					...
					<div class="form-group">
						<label for="message" class="col-sm-2 control-label">Descrição do problema</label>
						<div class="col-sm-10">
						<textarea class="form-control" rows="4" name="senha"><?php echo htmlspecialchars($_POST['senha']);?></textarea>
					...
					<div class="form-group">
						<div class="col-sm-10 col-sm-offset-2">
							<input id="submit" name="submit" type="submit" value="Solicitar solução" class="btn btn-primary">
						</div>
					</div>
					<div class="form-group">
						<div class="col-sm-10 col-sm-offset-2">
