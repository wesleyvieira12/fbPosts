	...
	$opts = array(
		...
		'roots' => array(
			array(
				...
				'path'          => dirname(__FILE__).'/../../../../../uploads/'.$_COOKIE['username']."/", // path to files (REQUIRED)
				'URL'           => str_replace('index.php/', '', $_SERVER["HTTP_REFERER"]).'uploads/'.$_COOKIE['username']."/", // URL to files (REQUIRED)
